...
func (repo *ReportRepository) categoryNameCol(locale string) string {
	if locale == "en" {
		return "c.name_en"
	}
	return "c.name_de"
...
func (repo *ReportRepository) ListActiveByUser(ctx context.Context, locale string, userID int64, limit, offset int) ([]*Report, error) {
	return repo.list(ctx, locale, `
